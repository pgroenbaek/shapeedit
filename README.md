...
This Python module provides safe operations for modifying existing MSTS/ORTS shape files that keeps the shape error-free and usable in MSTS and Open Rails.
