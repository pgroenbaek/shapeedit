...
This Python module provides a wrapper with operations for modifying existing MSTS/ORTS shape files that keeps them error-free and usable in MSTS and Open Rails.
